...
const users = [
    { username: 'anthony', password: 'anthony123', role: 'Administrator' },
    { username: 'prescilla', password: 'prescilla123', role: 'Registration Officer' },
    { username: 'albana', password: 'albana123', role: 'Support Staff' }
];
